...
| 11 | 10校章程/专业介绍（RAG） | 🔄 | **章程8/10校**已采集+chunk+embed完成（同济/华师大/财大/上外/华东理工/东华/上海大学/上海理工，共20个chunk）；**专业介绍1/10校**（华东师大，单页大而全，49个chunk）。`rag_chunks`共109条，全部已补embedding | 复旦（章程未本地托管+反爬412）、交大（章程是JS渲染SPA）本轮跳过；专业介绍剩余7所是"列表页链多篇学院文章"结构，需要先做子链接发现（华师大例外，是单页不需要）；上海理工专业介绍列表页多数条目外链微信公众号，采集可行性待评估。**转专业政策已明确不做**（2026-08-23），范围收窄为只做章程+专业介绍两类 |
