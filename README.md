...
| 版本 | 日期 | 主要变更 |
| ---- | ---------- | -------- |
| v0.5 | 2026-06-28 | 产品改名为问津 Agent，新增命名含义说明；去除 H5 / 微信内浏览器相关表述；不做清单去掉 Taro 多端重构 |
| v0.4 | 2026-06-28 | 首次拆分前后端 PRD；补充家庭协同流程图和人工复核流程图；补充分阶段建设计划和首期验收标准 |
...
- 前端 PRD 关注“用户怎么走完决策流程”，包括页面、表单、报告、协同和移动端体验。
...
问津 Agent 是面向高考生和家长的 **AI 志愿决策助理 + 专家复核咨询平台**，通过考生建档、招生规则校验、冲稳保方案生成、志愿表风险体检、家庭偏好协同和人工复核，帮助家庭形成可解释、可追溯、可复核的志愿填报方案。
...
| 用户         | 核心诉求                           | 产品价值                               |
| ------------ | ---------------------------------- | -------------------------------------- |
| 高考生       | 专业兴趣、城市体验、未来职业路径   | 让自己的偏好被结构化表达，并被家长理解 |
...
- 1 个免费复核闭环：AI 报告 + 高风险人工复核 + 家庭会议议程。
...
| Phase 4 | 复核与案例库 | 人工复核工作台、服务留痕、家庭协同、相似案例库               |
| Phase 5 | 扩展         | 多省份数据、自动更新校验、录取后服务                         |
...
```mermaid
flowchart TD
  FE["问津 Agent<br/>Next.js Web"] --> BFF["Next.js BFF / Route Handler"]
